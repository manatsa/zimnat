...
import static org.zimnat.domain.AddressAsserts.*;
...
class AddressResourceIT {
    ...
    public static Address createEntity(EntityManager em) {
        Address address = new Address().street(DEFAULT_STREET).location(DEFAULT_LOCATION).city(DEFAULT_CITY).country(DEFAULT_COUNTRY);
        return address;
    }
    ...
    public static Address createUpdatedEntity(EntityManager em) {
        Address address = new Address().street(UPDATED_STREET).location(UPDATED_LOCATION).city(UPDATED_CITY).country(UPDATED_COUNTRY);
        return address;
    }
    ...
    void putExistingAddress() throws Exception {
        ...
        updatedAddress.street(UPDATED_STREET).location(UPDATED_LOCATION).city(UPDATED_CITY).country(UPDATED_COUNTRY);
