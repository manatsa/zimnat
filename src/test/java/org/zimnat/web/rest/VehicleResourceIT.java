...
import static org.zimnat.domain.VehicleAsserts.*;
...
class VehicleResourceIT {
    ...
    public static Vehicle createEntity(EntityManager em) {
        Vehicle vehicle = new Vehicle().vRN(DEFAULT_V_RN).iDNumber(DEFAULT_I_D_NUMBER);
        return vehicle;
    }
    ...
    public static Vehicle createUpdatedEntity(EntityManager em) {
        Vehicle vehicle = new Vehicle().vRN(UPDATED_V_RN).iDNumber(UPDATED_I_D_NUMBER);
        return vehicle;
    }
    ...
    @Test
    @Transactional
    void checkvRNIsRequired() throws Exception {
    ...
    void putExistingVehicle() throws Exception {
        ...
        updatedVehicle.vRN(UPDATED_V_RN).iDNumber(UPDATED_I_D_NUMBER);
    ...
    void partialUpdateVehicleWithPatch() throws Exception {
        ...
        partialUpdatedVehicle.iDNumber(UPDATED_I_D_NUMBER);
    ...
    void fullUpdateVehicleWithPatch() throws Exception {
        ...
        partialUpdatedVehicle.vRN(UPDATED_V_RN).iDNumber(UPDATED_I_D_NUMBER);
